...
class Abcnn3(nn.Module):
    ...
    def __init__(self, emb_dim, sentence_length, filter_width, filter_channel=150, layer_size=2, match='cosine',
                 inception=True):
    ...
    def predict(self, x1, x2):
        ...
        pred = F.softmax(self.forward(x1, x2))
