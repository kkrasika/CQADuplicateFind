...
fileNameList = ['wordpress', 'webmasters', 'android','english', 'gaming', 'gis', 'mathematica', 'physics', 'programmers', 'stats', 'tex', 'unix']
...
for fileName in fileNameList:
    ...
    sentences = df_data.texts.to_list() #((df_data.texts.to_list(),df_data.texts2.to_list()))
    print(sentences[0])
